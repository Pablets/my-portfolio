        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
            ...
            <div className="-mr-2 -my-2 md:hidden">
              <button
                ...
                className="bg-transparent rounded-md p-2 inline-flex items-center justify-center text-gray-100 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
              >
            ...
            <nav className="hidden md:flex space-x-10">
              <div className="relative">
                ...
                <button
                  ...
                  type="button"
                  className="group bg-transparent rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-white focus:outline-none"
                >
                  <span>Solutions</span>
                  {/* <!--
            ...
            --> */}
                  <svg
                    className="ml-2 h-5 w-5 text-gray-400 group-hover:text-white"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
          ...
          --> */}
                ...
                <div
                  className={`${
                    toogle
                      ? "transition ease-out duration-400 h-0 opacity-0 overflow-hidden"
                      : "transition ease-out duration-400 h-auto opacity-100"
                ...
                >
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    <div className="relative grid gap-6 bg-gray-800 px-5 py-6 sm:gap-8 sm:p-8">
                      ...
                      {/* <a href='#anchor'  className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-600">
                        <svg
                          className="flex-shrink-0 h-6 w-6 text-gray-100"
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
              ...
              <a
                href="#anchor"
                className="text-base font-medium text-gray-500 hover:text-gray-500"
              >
                Pricing
              </a>
              <a
              ...
              <div className="relative">
                {/* <!-- Item active: "text-gray-500", Item inactive: "text-gray-500" --> */}
                <button
          ...
          --> */}
                      ...
                      <div>
                        ...
                        <ul className="mt-4 space-y-4">
                          <li className="text-base truncate">
                            <a href='#anchor'  className="font-medium text-gray-100 hover:text-white">
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <a
                href="#anchor"
                className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-500"
              >
                Sign in
              </a>
              <a
        ...
        <div
          className={`${
            isShown
              ...
              : "transition duration-200 ease-out opacity-0 scale-0"
            ...
            <div className="pt-5 pb-6 px-5">
              ...
              <div className="mt-6">
                <nav className="grid gap-y-8">
                  <a
                    href="#anchor"
                    className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-600"
                  >
                    {/* <!-- Heroicon name: outline/chart-bar --> */}
                    <svg
                      className="flex-shrink-0 h-6 w-6 text-gray-100"
                  ...
                  {/* <!-- Heroicon name: outline/shield-check --> */}
                  {/*                     
                  <a href='#anchor'  className="-m-3 p-3 flex items-center rounded-md hover:bg-gray-600">
                    <svg
                      className="flex-shrink-0 h-6 w-6 text-gray-100"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
