      ...
      <div class="fixed w-full m-0 p-0 bg-transparent ">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div class="flex justify-between items-center py-4 md:justify-start md:space-x-10">
            ...
            <nav class="hidden md:flex space-x-10">
              <div class="relative">
                ...
                <button
                  ...
                  type="button"
                  class="group bg-transparent rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-white focus:outline-none"
                >
                  <span>Solutions</span>
                  {/* <!--
            ...
            --> */}
                  <svg
                    class="ml-2 h-5 w-5 text-gray-400 group-hover:text-white"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
          ...
          --> */}
                ...
                >
                  <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                    ...
                    <div class="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8">
                      <div class="flow-root">
                        <a class="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-500 hover:bg-gray-100">
              ...
              <a class="text-base font-medium text-gray-500 hover:text-gray-500">
                Pricing
              </a>
              <a class="text-base font-medium text-gray-500 hover:text-gray-500">
                Docs
          ...
          --> */}
            ...
            <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <a class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-500">
                Sign in
              </a>
